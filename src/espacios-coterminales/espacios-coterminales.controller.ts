...
export class EspaciosCoterminalesController {
  ...
  @Get('nivel/:formacion')
  getNivelFormacion() {
    return this.espaciosCoterminalesService.getNivelFormacion();
  }
  @ApiResponse({
    status: 200,
  ...
  @Get('id/:idEspacio')
  findOne(@Param('idEspacio') idEspacio: string) {
    return this.espaciosCoterminalesService.findOne(idEspacio);
  }
  @ApiResponse({
    status: 200,
  ...
  @Patch(':idEspacio')
  update(
    @Param('idEspacio') idEspacio: string,
